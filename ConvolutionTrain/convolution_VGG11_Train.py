...
min_data = train_data.iloc[0:10000]
...
#VGG_19
# 第一层卷积段
model.add(Conv2D(input_shape=(48, 48, 1), filters=64, kernel_size=3, padding='same'))
...
model.save('my_VGG_11_ZZH_model_10000_200_100.h5')
